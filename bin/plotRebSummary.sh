...
#echo trender ${st} --dur $duration ${timebins} --title \"Reb Summary: ${1}\" --plot --layout 3x2 --outside --overlayregex -- \"${regexes[@]}\"
trender ${st} --site summit --fmt 'o-' --dpi 200 --dur $duration ${timebins} --title "Reb Summary: ${1}" --plot --layout 5x1 --outside --overlayregex -- "${regexes[@]}"
